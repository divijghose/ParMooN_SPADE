                                ...
                                double ***LocMatrices, double **LocRhs)
{
      ...
      if ((TDatabase::ParamDB->DISCTYPE == 5) || (TDatabase::ParamDB->DISCTYPE == 6) || (TDatabase::ParamDB->DISCTYPE == 7))
      {
            h = ComputeAlpha(hK);
            c0 += h;
      }
                                        ...
                                        double ***LocMatrices, double **LocRhs)
{
      ...
      if (TDatabase::ParamDB->INTERNAL_SOLD_ACTIVE)
      {
            ...
            c5 = coeff[5];
            // compute residual
            res = param[0] + theta1 * time_step * (-c0 * (param[3] + param[4]) + c1 * param[1] + c2 * param[2] + c3 * param[0]) - param[5] + theta2 * time_step * (-c0 * (param[8] + param[9]) + c1 * param[6] + c2 * param[7] + c3 * param[5]) - theta3 * time_step * c5 - theta4 * time_step * c4;
                                   ...
                                   CoeffFct2D *LinCoeffs)
{
      ...
      if (TDatabase::ParamDB->Axial3D)
      {
            ...
            DiscreteFormMatrixARhs = new TDiscreteForm2D(GalerkinString, allString, N_Terms_MatrixARhs, Derivatives_MatrixARhs,
            ...
            DiscreteFormMatrixMRhs_SUPG = new TDiscreteForm2D(SDFEMString, allString, N_Terms_MatrixMRhs_SUPG, Derivatives_MatrixMRhs_SUPG,
            ...
            // discrete form for assembling stiffness matrix and rhs (Galerkin FEM)
            DiscreteFormMatrixARhs_SUPG = new TDiscreteForm2D(SDFEMString, allString, N_Terms_MatricesAKRhs_SUPG, Derivatives_MatricesAKRhs_SUPG,
    ...
    CoeffFct2D *LinCoeffs, int NSTYPE)
{
      ...
      DiscreteFormGalerkinFrictionLocal = new TDiscreteForm2D(GalerkinString,
                                                              allString,
                                                              NSType3N_Terms, NSType3Derivatives,
                                                              NSType3SpaceNumbers,
                                                              NSType3N_Matrices, NSType3N_Rhs,
      ...
      DiscreteFormNLGalerkinFrictionLocal = new TDiscreteForm2D(GalerkinString, allString,
                                                                NSType3NLN_Terms, NSType3NLDerivatives,
                                                                NSType3NLSpaceNumbers,
                                                                NSType3NLN_Matrices, NSType3NLN_Rhs,
                                                                NSType3NLRowSpace, NSType3NLColumnSpace,
      ...
      DiscreteFormGalerkinFriction = new TDiscreteForm2D(GalerkinString,
                                                         allString,
                                                         NSType3N_Terms, NSType3Derivatives,
                                                         NSType3SpaceNumbers,
                                                         NSType3N_Matrices, NSType3N_Rhs,
      ...
      DiscreteFormNLGalerkinFriction = new TDiscreteForm2D(GalerkinString, allString,
                                                           NSType3NLN_Terms, NSType3NLDerivatives,
                                                           NSType3NLSpaceNumbers,
                                                           NSType3NLN_Matrices, NSType3NLN_Rhs,
                                                           NSType3NLRowSpace, NSType3NLColumnSpace,
                                      ...
                                      CoeffFct2D *BilinearCoeffs)
{
      ...
      DiscreteFormGalerkin = new TDiscreteForm2D(CdString, GalString, N_Terms, Derivatives, SpacesNumbers,
                                                 N_Matrices, N_Rhs, RowSpace, ColumnSpace, RhsSpace,
                                                 (AssembleFctParam2D *)BilinearAssembleGalerkin, BilinearCoeffs, NULL);

      DiscreteFormSDFEM = new TDiscreteForm2D(CdString, SDFEMString, N_Terms_SD, Derivatives_SD, SpacesNumbers_SD,
                                              N_Matrices, N_Rhs, RowSpace, ColumnSpace, RhsSpace,
                                              BilinearAssemble_SD, BilinearCoeffs, manipulate);

      DiscreteFormUpwind = new TDiscreteForm2D(CdString, UpwString, N_Terms, Derivatives, SpacesNumbers,
                                               N_Matrices, N_Rhs, RowSpace, ColumnSpace, RhsSpace,
                                               (AssembleFctParam2D *)BilinearAssemble_UPW2, BilinearCoeffs, NULL);

      DiscreteFormSOLD = new TDiscreteForm2D(CdString, SoldString, N_Terms_SD, Derivatives_SD, SpacesNumbers_SD,
                                             N_Matrices, 0, RowSpace, ColumnSpace, NULL,
                                             BilinearAssemble_SOLD, BilinearCoeffs, manipulate);

      DiscreteFormSOLD_Orthogonal = new TDiscreteForm2D(CdString, SoldString, N_Terms_SD, Derivatives_SD, SpacesNumbers_SD,
                                                        N_Matrices, 0, RowSpace, ColumnSpace, NULL,
                                                        BilinearAssemble_SOLD_Orthogonal, BilinearCoeffs, manipulate);

      DiscreteFormRhsLP96 = new TDiscreteForm2D(CdString, SDFEMString, N_Terms, Derivatives, SpacesNumbers,
                                                0, 1, NULL, NULL, RhsSpace,
                                                RhsAssemble_LP96, BilinearCoeffs, manipulate);

      DiscreteFormMH_Kno06 = new TDiscreteForm2D(CdString, SoldString, N_Terms_SD, Derivatives_SD, SpacesNumbers_SD,
                                                 N_Matrices, 0, RowSpace, ColumnSpace, NULL,
                                                 BilinearAssemble_MH_Kno06, BilinearCoeffs, manipulate);

      DiscreteFormSD_SOLD = new TDiscreteForm2D(CdString, SDFEMString, N_Terms_SD, Derivatives_SD, SpacesNumbers_SD,
                                                N_Matrices, N_Rhs, RowSpace, ColumnSpace, RhsSpace,
                                                BilinearAssemble_SD_SOLD, BilinearCoeffs, manipulate);

      DiscreteFormRhsAdjointEnergyErrorEstimate = new TDiscreteForm2D(CdString, SDFEMString, N_Terms_SD,
                                                                      Derivatives_SD, SpacesNumbers_SD,
                                                                      0, 1, NULL, NULL, RhsSpace,
                                                                      RhsAssemble_RhsAdjointEnergyEstimate, BilinearCoeffs, manipulate);

      DiscreteFormRhsAdjointTV = new TDiscreteForm2D(CdString, SDFEMString, N_Terms_SD,
                                                     Derivatives_SD, SpacesNumbers_SD,
                                                     0, 1, NULL, NULL, RhsSpace,
                                                     RhsAssemble_RhsAdjointTV, BilinearCoeffs, manipulate);

      DiscreteFormRhsAdjointTV2 = new TDiscreteForm2D(CdString, SDFEMString, N_Terms_SD,
                                                      Derivatives_SD, SpacesNumbers_SD,
                                                      0, 1, NULL, NULL, RhsSpace,
                                                      RhsAssemble_RhsAdjointTV2, BilinearCoeffs, manipulate);

      DiscreteFormRhsAdjointNormBL1_NormBorthL1 = new TDiscreteForm2D(CdString, SDFEMString, N_Terms_SD,
                                                                      Derivatives_SD, SpacesNumbers_SD,
                                                                      0, 1, NULL, NULL, RhsSpace,
                                                                      RhsAssemble_RhsAdjointNormBL1_NormBorthL1, BilinearCoeffs, manipulate);

      DiscreteFormRhsAdjointNormResidualL1_NormBorthL1 = new TDiscreteForm2D(CdString, SDFEMString, N_Terms_SD,
                                                                             Derivatives_SD, SpacesNumbers_SD,
                                                                             0, 1, NULL, NULL, RhsSpace,
                                                                             RhsAssemble_RhsAdjointNormResidualL1_NormBorthL1, BilinearCoeffs, manipulate);

      DiscreteFormRhsAdjointAll = new TDiscreteForm2D(CdString, SDFEMString, N_Terms_SD,
                                                      Derivatives_SD, SpacesNumbers_SD,
                                                      0, 1, NULL, NULL, RhsSpace,
                                                      RhsAssemble_RhsAdjointAll, BilinearCoeffs, manipulate);

      DiscreteFormRhsAdjointL2Error = new TDiscreteForm2D(CdString, SDFEMString, N_Terms_rhs,
                                                          Derivatives_rhs, SpacesNumbers_rhs,
                                                          0, 1, NULL, NULL, RhsSpace,
                                                          RhsAssemble_RhsAdjointL2Error, BilinearCoeffs, manipulate);

      DiscreteFormRhsAdjointH1Error = new TDiscreteForm2D(CdString, SDFEMString, N_Terms_SD,
                                                          Derivatives_SD, SpacesNumbers_SD,
                                                          0, 1, NULL, NULL, RhsSpace,
                                                          RhsAssemble_RhsAdjointH1Error, BilinearCoeffs, manipulate);

      DiscreteFormGalerkinMatrix = new TDiscreteForm2D(CdString, GalString, N_Terms, Derivatives, SpacesNumbers,
                                                       N_Matrices, 0, RowSpace, ColumnSpace, NULL,
                                                       (AssembleFctParam2D *)BilinearAssembleGalerkin, BilinearCoeffs, NULL);

      DiscreteForm2LevelLPS_Q0 = new TDiscreteForm2D(CdString, GalString, N_Terms, Derivatives, SpacesNumbers,
                                                     N_Matrices, N_Rhs, RowSpace, ColumnSpace, RhsSpace,
