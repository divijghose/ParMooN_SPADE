...
int main(int argc, char *argv[])
{
   ...
   * build-in function. The GEOFILE describes the boundary of the domain. */
    ...
    /*
    * N_Realisations is the number of Monte-Carlo realizations we want to run, input using the SDFEM_TYPE Paramater in tcd2d.dat ReadIn file.
    * LengthScale is the denominator in the exponential (exp(-||r1-r2||/L)) used as the correlation function. Input using paramter DELTA1 in tcd2d.dat ReadIn file.
    * EigenPercent is the percentage of eigen modes we want to retain. Input using parameter DELTA0 in tcd2d.dat ReadIn file.
    */
